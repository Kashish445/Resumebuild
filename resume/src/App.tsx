...
export default function App() {
  const [currentTab, setCurrentTab] = useState(CurrentTab.Edit);
  const [resumeData, setResumeData] = useState<ResumeData | null>(null);
  const { setIsOpen: setTourIsOpen } = useTour();
  const [displayingUpdateIsAvailable, setDisplayingUpdateIsAvailable] =
    useState(false);
  ...
  const debounce = useDebouncedAction();
