...
const Faq = () => {
  return (
    <section className="bg-violet-200 text-gray-100 py-32 min-h-screen">
    <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
      ...
      <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">How can I place an order?</summary>
        ...
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">What payment methods do you accept?</summary>
          <div className="px-4 pb-4">
        ...
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">How long does shipping take?</summary>
          <div className="px-4 pb-4">
        ...
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">Can I return a product if Im not satisfied?</summary>
          <div className="px-4 pb-4">
        ...
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">Do you offer international shipping?</summary>
          <div className="px-4 pb-4">
        ...
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">What is your customer support contact?</summary>
          <div className="px-4 pb-4">
        ...
        <details>
          <summary className="text-fuchsia-950 py-2 outline-none cursor-pointer focus:underline">What are your terms and conditions?</summary>
          <div className="px-4 pb-4">
