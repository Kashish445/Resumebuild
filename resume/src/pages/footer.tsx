...
const Content = () => {
  return (
    <footer className="bg-purple-950 py-8 px-10 font-[sans-serif]">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Email:resuma@gmail.com</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Phone:+916754324599</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Address:resuma headoffice,aundh 411011</a>
            </li>
          </ul>
        </div>
        <div>
      ...
      <p className='text-gray-300 text-sm mt-8'>© 2024<a href='https://readymadeui.com/' target='_blank'
        className="hover:underline mx-1">Resuma</a>All Rights Reserved.
      </p>
    </footer>
  )
}
